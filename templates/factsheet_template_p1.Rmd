...
\begin{tikzpicture}
 ...
 \node[above right = 0.65cm and 0.8cm of current page.south west, align = left, font = \scriptsize] {Detailed methods for all figures are described in the companion document (\link{`r companion_link`}{Aquifer Factsheet - Companion Document.pdf}).};
