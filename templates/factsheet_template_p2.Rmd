...
\begin{tikzpicture}
  ...
  \node[above left = 0.1cm and 0.5cm of current page.south east, font = \scriptsize] {Detailed methods for all figures are described in the companion document (\link[grey]{../Aquifer Factsheet - Companion Document.pdf}{Aquifer Factsheet - Companion Document.pdf})};
