...
\begin{tikzpicture}
  ...
  \node[below right = 0.6cm and 0.6cm of current page.north west, white, font = \large\bf] (map_link) {\link[lightgrey]{`r f2$ow_map_link`}{(Interactive map)}};
  \node[below = 0.6cm of current page.north, white, font = \large\bf] (num) {Observation Well \#`r f2$ow` (\link[lightgrey]{`r f2$ow_well_record`}{Well record})};
  \node[below left = 0.65cm and 0.55cm of current page.north east, white, font = \bf] (num) {Aquifer \#`r f2$aquifer_id`};

  `r # Figures (width = 0.94\paperwidth`
  \node[below = 0.85cm of line0, anchor = north] (ground) {\includegraphics[height = 0.29\paperheight]{`r here(f2$p2_gwl_ppt)`}};
  \node[below = 0.85cm of line1, anchor = north] (trend) {\includegraphics[height = 0.29\paperheight]{`r here(f2$p2_gwl_trends)`}};
  \node[below right = 0.55cm and 1cm of line2l, anchor = north west] (piper) {\includegraphics[height = 0.29\paperheight]{`r here(f2$p2_piperplots)`}};
  ...
  `r # Piper Text`
  \node[below left = 0.5cm and 0.5cm of line2r, anchor = north east, align = left, text width = 10cm, font = \small\bf] (pipertext){`r f2$ow_piper_text`};
