...
\begin{tikzpicture}
  ...
  `r # Map figure`
  \node[below = 2.6cm of current page.north] (map) {\includegraphics{`r here(figs_p1$p1_maps)`}};
  
  `r # Boxplots`
  \node[below = 0.25cm of map.south east, anchor = north east] (third) {\includegraphics[width = 0.175\paperwidth]{`r here(figs_p1$p1_well_depth)`}};
  \node[left = 0cm of third.north west, anchor = north east] (second) {\includegraphics[width = 0.175\paperwidth]{`r here(figs_p1$p1_water_depth)`}};
  \node[left = 0cm of second.north west, anchor = north east] (first) {\includegraphics[width = 0.175\paperwidth]{`r here(figs_p1$p1_well_yield)`}};
